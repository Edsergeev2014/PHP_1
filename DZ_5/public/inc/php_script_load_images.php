    ...
    while (false !== ($file = readdir($dir))) {
        ...
        if(!is_dir($file) && (strpos($file, '.jpg')>0 || strpos($file, '.gif')>0 || strpos($file, '.png')>0) ) {
            ...
            $Images_from_dir = [
                ...
                'image_file_path'   => $path_images, //'public/images/', 
                'thumbnail_name'    => $file, 
                'thumbnail_path'    => $path_thumbnails,  //'public/images/thumbnails/'
                'popularity'        => '3', 
...
function mysqli_insert($mysql, $table, $inserts) {
    ...
    // VALUES ('', 'halat-zhenskij-venera-mart-ru-cvetok-persika.jpg', '64505', 'public/images/', 'halat-zhenskij-venera-mart-ru-cvetok-persika.jpg', 'public/images/thumbnails/', '3', 'Товар 1')
